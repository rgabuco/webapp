$(document).ready(async function () {
  ...
  $(document).on("input", function () {
    ...
    if (
      name.trim() !== selectedStudio.name.trim() ||
  ...
  $(document).ready(function () {
    ...
    $(document).on("click", "#confirmDelete", async function () {
      ...
      studioData = studioData.filter((studio) => {
        return (
          studio.name !== selectedStudio.name ||
    ...
    $(document).on("click", "#confirmSave", async function () {
      ...
      const studioIndex = studioData.findIndex((studio) => studio.name === selectedStudio.name || studio.name === oldStudioName);
